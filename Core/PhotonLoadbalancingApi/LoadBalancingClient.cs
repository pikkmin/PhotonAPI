...
namespace Photon.Realtime
{
    ...
    public class LoadBalancingClient : IPhotonPeerListener
    {
        ...
        public bool ConnectToNameServer()
        {
            ...
            {
                DebugReturn(DebugLevel.ALL, "Setting expected to current: "+this.LoadBalancingPeer.TransportProtocol);
                this.ExpectedProtocol = this.LoadBalancingPeer.TransportProtocol;
            }
        ...
        /// <param name="propertiesToSet">ExitGames.Client.Photon.Hashtable of Custom Properties that changes.</param>
        ...
        public bool OpSetCustomPropertiesOfActor(int actorNr, ExitGames.Client.Photon.Hashtable propertiesToSet, ExitGames.Client.Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ...
            ExitGames.Client.Photon.Hashtable customActorProperties = new ExitGames.Client.Photon.Hashtable();
        ...
        {
            ExitGames.Client.Photon.Hashtable customGameProps = new ExitGames.Client.Photon.Hashtable();
        ...
        /// <summary>Internally used to cache and set properties (including well known properties).</summary>
        /// <remarks>Requires being in a room (because this attempts to send an operation which will fail otherwise).</remarks>
        public bool OpSetPropertiesOfRoom(ExitGames.Client.Photon.Hashtable gameProperties, ExitGames.Client.Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            if (!this.CheckIfOpCanBeSent(OperationCode.SetProperties, this.Server, "SetProperties"))
            {
                return false;
        ...
        private void ReadoutProperties(ExitGames.Client.Photon.Hashtable gameProperties, ExitGames.Client.Photon.Hashtable actorProperties, int targetActorNr)
        {
            ...
            if (actorProperties != null && actorProperties.Count > 0)
            {
                if (targetActorNr > 0)
                {
                    ...
                    if (target != null)
                    {
                        ExitGames.Client.Photon.Hashtable props = this.ReadoutPropertiesForActorNr(actorProperties, targetActorNr);
                ...
                else
                {
                    ...
                    {
                        actorNr = (int)key;
                        props = (ExitGames.Client.Photon.Hashtable)actorProperties[key];
        ...
        private void GameEnteredOnGameServer(OperationResponse operationResponse)
        {
            ...
            ExitGames.Client.Photon.Hashtable actorProperties = (ExitGames.Client.Photon.Hashtable)operationResponse[ParameterCode.PlayerProperties];
            ExitGames.Client.Photon.Hashtable gameProperties = (ExitGames.Client.Photon.Hashtable)operationResponse[ParameterCode.GameProperties];
        ...
        public virtual void OnOperationResponse(OperationResponse operationResponse)
        {
            ...
            switch (operationResponse.OperationCode)
            {
                ...
                case OperationCode.AuthenticateOnce:
                    {
                        ...
                        else if (this.Server == ServerConnection.GameServer)
                        {
                            ...
                            {
                                ExitGames.Client.Photon.Hashtable allProps = new ExitGames.Client.Photon.Hashtable();
                ...
                case OperationCode.GetGameList:
                    ...
                    ExitGames.Client.Photon.Hashtable games = (ExitGames.Client.Photon.Hashtable)operationResponse[ParameterCode.GameList];
                    foreach (string gameName in games.Keys)
                    {
                        _RoomInfoList.Add(new RoomInfo(gameName, (ExitGames.Client.Photon.Hashtable)games[gameName]));
                    }
        ...
        public virtual void OnEvent(EventData photonEvent)
        {
            ...
            switch (photonEvent.Code)
            {
                ...
                case EventCode.GameListUpdate:
                    ...
                    ExitGames.Client.Photon.Hashtable games = (ExitGames.Client.Photon.Hashtable)photonEvent[ParameterCode.GameList];
                    foreach (string gameName in games.Keys)
                    {
                        _RoomInfoList.Add(new RoomInfo(gameName, (ExitGames.Client.Photon.Hashtable)games[gameName]));
                    }
                ...
                case EventCode.Join:
                    ExitGames.Client.Photon.Hashtable actorProperties = (ExitGames.Client.Photon.Hashtable)photonEvent[ParameterCode.PlayerProperties];
                ...
                case EventCode.PropertiesChanged:
                    ...
                    ExitGames.Client.Photon.Hashtable actorProps = null;
                    if (targetActorNr == 0)
                    {
                        gameProperties = (ExitGames.Client.Photon.Hashtable)photonEvent[ParameterCode.Properties];
                    }
                    else
                    {
                        actorProps = (ExitGames.Client.Photon.Hashtable)photonEvent[ParameterCode.Properties];
                    }
    ...
    public interface IInRoomCallbacks
    {
        ...
        /// </summary>
        /// <remarks>
        /// Since v1.25 this method has one parameter: ExitGames.Client.Photon.Hashtable propertiesThatChanged.<br/>
