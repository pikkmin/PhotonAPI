...
namespace Photon.Realtime
{
    ...
    public class Player
    {
        ...
        /// <remarks>
        /// Don't modify the content of this ExitGames.Client.Photon.Hashtable. Use SetCustomProperties and the
        ...
        /// <param name="actorNumber">ID or ActorNumber of this player in the current room (a shortcut to identify each player in room)</param>
        /// <param name="isLocal">If this is the local peer's player (or a remote one).</param>
        /// <param name="playerProperties">A ExitGames.Client.Photon.Hashtable of custom properties to be synced. Must use String-typed keys and serializable datatypes as values.</param>
        ...
        /// </remarks>
        public virtual void InternalCacheProperties(ExitGames.Client.Photon.Hashtable properties)
        {
        ...
        /// </remarks>
        /// <param name="propertiesToSet">ExitGames.Client.Photon.Hashtable of Custom Properties to be set. </param>
        ...
        public bool SetCustomProperties(ExitGames.Client.Photon.Hashtable propertiesToSet, ExitGames.Client.Photon.Hashtable expectedValues = null, WebFlags webFlags = null)
        {
            ...
            ExitGames.Client.Photon.Hashtable customPropsToCheck = expectedValues.StripToStringKeys() as ExitGames.Client.Photon.Hashtable;
            ...
            if (this.RoomReference != null)
            {
                ...
                else
                {
                    ...
                    return this.RoomReference.LoadBalancingClient.LoadBalancingPeer.OpSetPropertiesOfActor(this.actorNumber, customProps, customPropsToCheck, webFlags);
                }
            }
        ...
        private bool SetPlayerNameProperty()
        {
            if (this.RoomReference != null && !this.RoomReference.IsOffline)
            {
                ...
                return this.RoomReference.LoadBalancingClient.LoadBalancingPeer.OpSetPropertiesOfActor(this.ActorNumber, properties);
            }
