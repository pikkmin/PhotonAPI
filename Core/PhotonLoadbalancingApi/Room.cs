...
namespace Photon.Realtime
{
    ...
    public class Room : RoomInfo
    {
        ...
        public new bool IsOpen
        {
            ...
            set
            {
                if (value != this.isOpen)
                {
                    if (!this.isOffline)
                    {
                        this.LoadBalancingClient.OpSetPropertiesOfRoom(new ExitGames.Client.Photon.Hashtable() { { GamePropertyKey.IsOpen, value } });
                    }
                }
        ...
        public new bool IsVisible
        {
            ...
            set
            {
                if (value != this.isVisible)
                {
                    if (!this.isOffline)
                    {
                        this.LoadBalancingClient.OpSetPropertiesOfRoom(new ExitGames.Client.Photon.Hashtable() { { GamePropertyKey.IsVisible, value } });
                    }
                }
        ...
        public new byte MaxPlayers
        {
            ...
            set
            {
                if (value != this.maxPlayers)
                {
                    if (!this.isOffline)
                    {
                        this.LoadBalancingClient.OpSetPropertiesOfRoom(new ExitGames.Client.Photon.Hashtable() { { GamePropertyKey.MaxPlayers, value } });
                    }
                }
        ...
        public virtual void SetCustomProperties(ExitGames.Client.Photon.Hashtable propertiesToSet, ExitGames.Client.Photon.Hashtable expectedProperties = null, WebFlags webFlags = null)
        {
            ExitGames.Client.Photon.Hashtable customProps = propertiesToSet.StripToStringKeys() as ExitGames.Client.Photon.Hashtable;
        ...
        {
            ExitGames.Client.Photon.Hashtable newProps = new ExitGames.Client.Photon.Hashtable() { { GamePropertyKey.MasterClientId, masterClientPlayer.ActorNumber } };
            ExitGames.Client.Photon.Hashtable prevProps = new ExitGames.Client.Photon.Hashtable() { { GamePropertyKey.MasterClientId, this.MasterClientId } };
